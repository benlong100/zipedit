...
See [CHANGELOG.md](CHANGELOG.md). 1.4 builds in any language and ships in
Slovenian, and makes find wrap round the end of the document — which turned
up two older bugs on the way: find again had never advanced at all, and a
match lying against the end of the document could not be found.
